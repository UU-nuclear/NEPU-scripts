...
model_hetGP_exp_SqrExp <- read_object(20,"model_hetGP_exp_SqrExp")
model_hetGP_exp_Mat3_2 <- read_object(20,"model_hetGP_exp_Mat3_2")
model_hetGP_exp_Mat5_2 <- read_object(20,"model_hetGP_exp_Mat5_2")

pred_hetGP_exp_SqrExp <- read_object(20,"pred_hetGP_exp_SqrExp")
pred_hetGP_exp_Mat3_2 <- read_object(20,"pred_hetGP_exp_Mat3_2")
pred_hetGP_exp_Mat5_2 <- read_object(20,"pred_hetGP_exp_Mat5_2")
