...
#echo "*                        step02                                      *"
#echo "**********************************************************************"
##apptainer exec instance://pipeline-inst mpirun -np 1 Rscript --vanilla script/02_create_reference_calculation_mpi.R $3
##apptainer exec instance://pipeline-inst mpirun -np 1 Rscript --vanilla script/02_create_reference_calculation_with_unc.R $3
...
#echo "*                        step06                                      *"
#echo "**********************************************************************"
##apptainer exec instance://pipeline-inst Rscript --vanilla script/06_tune_endep_hyperpars.R $3
##apptainer exec instance://pipeline-inst Rscript --vanilla script/06_tune_endep_hyperpars_fixed_sigma.R $3
#apptainer exec instance://pipeline-inst Rscript --vanilla script/06_tune_endep_hyperpars_with_unc.R $3
...
#apptainer exec instance://pipeline-inst mkdir /TMC/alf/test-dir
