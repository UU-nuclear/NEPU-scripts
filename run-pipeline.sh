...
echo "*                        step06                                      *"
echo "**********************************************************************"
apptainer exec instance://pipeline-inst Rscript --vanilla script-Cr/06_tune_endep_hyperpars_with_prior.R $3
...
echo "*                        step10                                      *"
echo "**********************************************************************"
apptainer exec instance://pipeline-inst mpirun -np 1 Rscript --vanilla script-Cr/10_tune_talyspars_with_defect_gp_obs_all_endep_free.R $3
