...
plotPath <- "/home/alf/projects/NucDat/NAISS/UPPMAX/2023-22-58/eval-fe56-scripts/defect-model/figures-Fe56-to10MeV"
...
# norm of the final projected gradient 0.848767
# final function value 59379.4
# 
# X = 0.414755 0.379093 0.328966 0.293481 0.257886 0.222339 0.186755 0.151233 0.130151 0.098566 0.0985646 0.0985646 0.0985646 0.0985653 0.0985659 0.00248506 0.322067 4.95414 
# F = 59379.4
# final  value 59379.374392 
# converged
hyper_pars_optim <- c(0.414755, 0.379093, 0.328966, 0.293481, 0.257886, 0.222339, 0.186755, 0.151233, 0.130151, 0.098566, 0.0985646, 0.0985646, 0.0985646, 0.0985653, 0.0985659, 0.00248506, 0.322067, 4.95414)
##################################################
...
ggp <- ggplot(data=expDt) +
  ...
  geom_line(aes(x=L1,y=default_prediction),data=fake_expDt , color='orange', alpha=0.5) +
  facet_wrap(~ REAC, ncol=2, scales="free_y") +
  labs(x="neutron energy (MeV)", y="cross section (mbarn)") +
  theme_bw() +
  theme(panel.grid.major = element_blank(), 
