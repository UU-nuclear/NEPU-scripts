...
# maually modified energy grid for speed of calculation
energyGrid <- c(seq(1.8,9.0,by=0.3),seq(9.5,15.0,by=0.5),seq(16.0,30.,by=1.),seq(32.0,50.,by=2.))
...
source("misc-scripts/ParameterTransform.R")
...
outdataPath <- file.path(workdir, "/outdata-new-par-transf")
...
pathTalys <- "/TMC/alf/eval-fe56-singularity/talysResults-new-par-transf"
