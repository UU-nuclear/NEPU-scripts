...
# test to extract the GP piece-wise linear
...
updSysDt[ERRTYPE=="pw", DATA := as.vector(polygon_chain_parameters)]$DATA
...
updSysDt[ERRTYPE=="pw", V1 := as.vector(polygon_chain_parameters)]$DATA
...
updSysDt[ERRTYPE=="pw", V2 := as.vector(polygon_chain_parameters)]$DATA
...
#geom_line(data = updSysDt[ERRTYPE=="pw" & EXPID=="REACEXP-N,TOT-01"],aes(x = EN_POLY_CHAIN, y = XS_POLY_CHAIN_STAT, col='only stat. unc.')) +
