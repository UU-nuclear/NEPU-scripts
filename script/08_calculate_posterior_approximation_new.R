...
# expansion at the parameter set 
# found by the Levenberg-Marquardt algorithm.
#
# The parameter update equation in this script is different from
# the original one in 08_calculate_posterior_approximation.R
# in that it solve the problem vec{G} = vec{0} exactly, instead of setting
# the gradient of the taylor expansion to vec{0}.  
...
# p0 is the prior of all paramters, adjustable or not
