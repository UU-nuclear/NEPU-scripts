...
JOBID_00=$(sbatch pipeline-job-00.sh) &&
JOBID_01=$(sbatch --dependency=afterok:${JOBID_00##* } pipeline-job-01.sh) &&
...
JOBID_07=$(sbatch --dependency=afterok:${JOBID_06##* } pipeline-job-07.sh)
